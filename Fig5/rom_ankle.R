...
# The residual distribution is a bit skewed. To reduce it, I transform the data with x^2. 

# RESULTS:

# - day1 significantly different than day-1  (p < 0.001)
# - day9 NOT significantly different than day-1  (p = 0.0586)
# - day45 NOT significantly different than day-1 (p = 0.7805)
